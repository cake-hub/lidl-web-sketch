...
* "Popover" | Fixed symbol: height of md-xs/left
...
* "Popover" | Changed symbol: color of text from "gray-base" to "gray-darker"

### Fixed

* "Popover" | Fixed symbol: resizing of top- and bottom-center (LG)
...
* "Popover" | Changed symbols to new smart layout of Sketch
* "Popover" | Changed symbols with layer styles
